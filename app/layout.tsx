    ...
    <html lang="en">
      <body className="min-h-screen flex flex-col bg-[#f9fafb] text-slate-900 antialiased">
        ...
        <CartProvider>
          ...
          <main className={`grow w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 transition-all duration-700 ${isLoading ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`}>
            {children}
          </main>
